    ...
    return(
        <div className={styles.wrapper}>
            <div className={styles.storyName}>
                ...
                <textarea className={styles.inputBox} value={projectName} onChange={handleNameChange} placeholder="프로젝트 이름"
            ...
            <div className={styles.storyImage}>
                ...
                <p style={{fontSize:'18px', fontWeight:'lighter'}}>SparkSeed의 검색 결과 및 매인 화면에 보여지는 이미지입니다.</p>
                <div className={styles.grayBox}>
                    <span style={{fontSize:'18px', fontWeight:'lighter', padding:'10px'}}> • 10MB 이하의 JPG. JPEG, PNG 파일<br/> • 1:1 비율이 가장 적절합니다.<br/> • 해상도 1200x675 픽셀 이상</span>
                </div>
                <ImageSave maxImageCount={1} onImagesChange={handleTitleImagesChange} />
            </div>
            <div className={styles.cardImg}>
                <p style={{fontSize:'18px'}}>소개 사진 등록</p>
                <p style={{fontSize:'18px', fontWeight:'lighter'}}>펀딩 페이지가 등록되면 가장 처음에 보여지는 사진입니다.</p>
                <div className={styles.grayBox} style={{padding:'10px', marginBottom:'10px'}}>
                    <span style={{fontSize:'18px', fontWeight:'lighter'}}> • 2MB 이하의 JPG. JPEG, PNG 파일<br/> • 1:1 비율이 가장 적절합니다.<br/> • 해상도 1440x864 픽셀 이하<br/> • 최대 8개까지 등록 가능합니다.</span>
                </div>
            ...
            <div className={styles.projectSum}>
                ...
                <textarea className={styles.inputBox} style={{height:'120px', width:'845px'}} value={projectSummary} onChange={handleSummaryChange} placeholder="프로젝트 내용 요약" />
            ...
            <div className={styles.projectStory}>
                ...
                <p style={{fontSize:'18px', fontWeight:'lighter'}}>프로젝트 스토리는 프로젝트의 정체성을 보여주는 부분입니다.<br/> 정체성을 잘 적어서 꼭 목표금액까지 펀딩을 달성해보아요!</p>
                <ToastUi/>
            </div>
            <div className={styles.saveBtn} onClick={handleSubmit} style={{display:'flex', justifySelf:'end', cursor:'pointer'}}>저장하기</div>
        </div>
    );
};
