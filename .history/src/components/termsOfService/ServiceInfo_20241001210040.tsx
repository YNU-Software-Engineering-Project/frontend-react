...
const ServiceInfo =()=> {
  ...
  const handlePolicyInfoNavigation = () => {
    navigate('/terms-of-service', { state: { section: 'PolicyInfo' } });
  };
  ...
  return(
    <div className = {styles.wrapper}>
        <div className={styles.header}>
          ...
          <button className={styles.buttonComponent} onClick={handlePolicyInfoNavigation}></button>
