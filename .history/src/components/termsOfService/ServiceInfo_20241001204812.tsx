...
const ServiceInfo  =  () => {
  ...
  const togglePolicyInfo = () => {
    setShowPolicyInfo(!showPolicyInfo);
  };
  ...
  return(
    <div className = {styles.wrapper}>
        <div className={styles.header}>
          ...
          <button className={styles.buttonComponent} onClick={togglePolicyInfo}>더보기</button> {showPolicyInfo && <PolicyInfo />} /* 지우기 */
